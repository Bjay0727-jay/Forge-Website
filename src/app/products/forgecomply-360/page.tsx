...
const capabilities = [
  ...
  { capability: 'Evidence-Grade Proof for Auditors', forge: 'full', typical: 'partial', desc: 'Output that satisfies 3PAOs and assessors, not just internal dashboards.' },
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-navy-900 via-navy-700 to-navy-600 text-white pt-40 pb-28 px-8 relative overflow-hidden">
        ...
        <div className="max-w-[1120px] mx-auto relative z-10 text-center">
          <div className="inline-flex items-center gap-2 bg-teal-500/[0.08] border border-teal-500/20 px-5 py-2 rounded-full mb-8">
            <span className="w-1.5 h-1.5 rounded-full bg-teal-400 animate-pulse" />
            <span className="text-[11px] font-semibold tracking-[1.5px] uppercase text-teal-400">Continuous Trust &amp; Assurance Platform</span>
          </div>
      ...
      {/* ═══ THE PROBLEM ═══ */}
      <section className="py-28 px-8 bg-navy-800 border-t border-white/[0.06]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <h2 className="text-3xl md:text-[42px] font-extrabold text-white leading-[1.12] tracking-tight mb-4">
                Your compliance tool shows green.<br />Your <span className="text-teal-400">auditor</span> sees red.
              </h2>
              <p className="text-base text-white/50 max-w-[520px] leading-relaxed">
                Most compliance platforms automate evidence collection and show dashboards. But when the 3PAO arrives or the board asks hard questions, surface-level automation doesn&apos;t hold up. You need validated assurance — not just a monitoring feed.
              </p>
            </div>
            <div className="space-y-3.5">
              {problems.map((p) => (
                <div key={p.title} className="bg-white/[0.04] border border-white/[0.08] rounded-xl p-6 flex gap-4 items-start transition-all hover:border-teal-500/20 hover:bg-white/[0.06]">
                  <div className={`w-10 h-10 min-w-[40px] rounded-lg flex items-center justify-center ${p.color}`}>
      ...
      {/* ═══ FEATURES ═══ */}
      <section id="features" className="py-28 px-8 bg-navy-900 border-t border-white/[0.06]">
        <div className="max-w-[1120px] mx-auto text-center">
          <span className="text-[13px] font-semibold uppercase tracking-[1.5px] text-teal-400 mb-4 block">The ForgeComply Difference</span>
          <h2 className="text-3xl md:text-[42px] font-extrabold text-white leading-[1.12] tracking-tight mb-4 max-w-[600px] mx-auto">
            Controls Monitored.<br />Controls Validated. <span className="text-teal-400">Controls Proven.</span>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map((f) => (
              <div key={f.title} className="bg-white/[0.04] border border-white/[0.08] rounded-xl p-8 text-left transition-all hover:border-teal-500/25 hover:-translate-y-1 hover:shadow-[0_10px_40px_rgba(0,0,0,0.25)]">
                <div className="w-11 h-11 rounded-[10px] bg-teal-500/15 flex items-center justify-center mb-5">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5 mt-16">
            {stats.map((s) => (
              <div key={s.label} className="text-center">
                <div className="text-4xl font-extrabold text-teal-400 tracking-tight mb-1">{s.value}</div>
      ...
      <section className="py-28 px-8 bg-navy-800 border-t border-white/[0.06]">
        <div className="max-w-[1120px] mx-auto text-center">
          <span className="text-[13px] font-semibold uppercase tracking-[1.5px] text-teal-400 mb-4 block">What Sets Us Apart</span>
          <h2 className="text-3xl md:text-[42px] font-extrabold text-white leading-[1.12] tracking-tight mb-4 max-w-[600px] mx-auto">
            The gap between <span className="text-teal-400">monitoring</span><br />and <span className="text-teal-400">proof</span>
          </h2>
          <p className="text-base text-white/50 max-w-[520px] mx-auto mb-12 leading-relaxed">
      ...
      {/* ═══ FRAMEWORKS ═══ */}
      <section className="py-28 px-8 bg-navy-900 border-t border-white/[0.06]">
        <div className="max-w-[1120px] mx-auto text-center">
          <span className="text-[13px] font-semibold uppercase tracking-[1.5px] text-teal-400 mb-4 block">Multi-Framework Coverage</span>
          <h2 className="text-3xl md:text-[42px] font-extrabold text-white leading-[1.12] tracking-tight mb-4 max-w-[550px] mx-auto">
