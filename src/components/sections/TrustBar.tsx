...
export default function TrustBar() {
  return (
    <section className="py-20 px-8 bg-navy-800 border-y border-white/[0.06]">
      <div className="max-w-[1280px] mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          {stats.map((stat) => (
            <div key={stat.label} className="flex items-center gap-5">
              <div className="w-16 h-16 rounded-xl bg-teal-500/15 flex items-center justify-center shrink-0">
