      ...
      <div className="max-w-[1280px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-16">
          <div className="lg:col-span-2">
            <SectionHeading label="Get In Touch" title="Let's Secure Your Mission" subtitle="Whether you need compliance consulting, a secure application built from scratch, or both — we're ready to help. Tell us about your project and we'll respond within 24 hours." />
