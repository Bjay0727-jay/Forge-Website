import { Shield, MessageSquare, Code } from 'lucide-react';
    ...
    <section className="bg-gradient-to-br from-navy-900 via-navy-700 to-navy-600 text-white pt-40 pb-32 px-8 relative overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto relative z-10">
        ...
        <p className="text-xl text-white/80 leading-relaxed max-w-[660px] mb-4 font-medium">
          Compliance experts who also build the software.
        </p>
        <p className="text-lg text-white/60 leading-relaxed max-w-[640px] mb-12">
          We guide organizations from gap analysis through full ATO — and build the secure applications to match. FedRAMP, CMMC, FISMA, HIPAA, and SOC 2.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-[900px]">
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-8 transition-all hover:bg-white/[0.08] hover:border-blue-500/40 hover:-translate-y-1">
            ...
            <p className="text-sm text-white/65 leading-relaxed">Secure custom applications — government portals, enterprise SaaS, compliance platforms — with security engineered in from day one.</p>
          </div>
        </div>
      </div>
    </section>
